...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const productItems = (products || []).map((product) => {
    ...
    return {
      ...
      status: product.config?.inventory?.stock > 0 ? "In Stock" : "Sold Out"
    };
  });
