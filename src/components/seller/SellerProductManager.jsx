                                                                    ...
                                                                    <tbody className="divide-y divide-white/5">
                                                                        {formData.variantCombinations.map((combo, idx) => (
                                                                            <tr key={idx}>
                                                                                ...
                                                                                <td className="p-3"><input type="number" value={combo.price} onChange={e => updateCombinationField(idx, 'price', e.target.value)} className="bg-black/50 border border-white/10 rounded px-2 py-1 w-24 text-white text-xs" /></td>
